        ...
        <article class="contents span8">
            ...
            <section class="video-details">
                ...
                <div class="socialize" data-id="<?php the_ID(); ?>">
                    <span class="pulished"><?php _e('Published Date:', 'exc-proplay-theme'); ?> <?php echo get_the_date(); ?></span>
                    <a class="btn btn-green-grad" id="video_like" href="javascript:void(0);">
                        <i class="icon-like2"></i><?php _e('Like', 'exc-proplay-theme'); ?> ( <span><?php echo fw_get_votes(get_the_ID(),'like');?></span> )
                    </a>
                    <a class="btn btn-red-grad" id="video_dislike" href="javascript:void(0);">
                        <i class="icon-dislike2"></i><?php _e('Dislike', 'exc-proplay-theme'); ?> ( <span><?php echo fw_get_votes(get_the_ID(),'dislike');?></span> )
                    </a>

                    <?php if( $GLOBALS['_webnukes']->fw_get_settings('sub_general_settings', 'post_views') == 'on' ):?>
                        <span class="pulished"><?php _e('Views:', 'exc-proplay-theme'); ?> <?php echo fw_get_post_views( get_the_ID() ); ?></span>
                    <?php endif; ?>
                        ...
                        <div class="user-data">
                            ...
                            <p>
                                <a href="<?php echo get_author_posts_url( get_the_author_meta( 'ID' ) ); ?>">
                                    ...
                                    <?php echo ( $type == 'video' ) ? __('Videos', 'exc-proplay-theme') : __('Audios', 'exc-proplay-theme'); ?>
                                </a>
                            </p>
                        </div>
                    </div>
                    <div class="description">
                        <h6><?php _e('Description:', 'exc-proplay-theme'); ?></h6>
