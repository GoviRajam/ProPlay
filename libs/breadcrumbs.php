...
function get_the_breadcrumb()
{
    ...
    {
        $breadcrumb .= '<li><a href="'.home_url().'">'.__('Home', 'exc-proplay-theme').'</a></li>';
        ...
        elseif(is_day()) $breadcrumb .= '<li><a href="">'.__('Archive for ', 'exc-socialplay-theme').get_the_time('F jS, Y').'</a></li>'; /** If daily Archives */
        elseif(is_month()) $breadcrumb .= '<li><a href="' .get_month_link(get_the_time('Y'), get_the_time('m')) .'">'.__('Archive for ', 'exc-proplay-theme').get_the_time('F, Y').'</a></li>'; /** If montly Archives */
        elseif(is_year()) $breadcrumb .= '<li><a href="'.get_year_link(get_the_time('Y')).'">'.__('Archive for ', 'exc-proplay-theme').get_the_time('Y').'</a></li>'; /** If year Archives */
        elseif(is_author()) $breadcrumb .= '<li><a href="'. esc_url( get_author_posts_url( get_the_author_meta( "ID" ) ) ) .'">'.__('Archive for ', 'exc-proplay-theme').get_the_author().'</a></li>'; /** If author Archives */
        elseif(is_search()) $breadcrumb .= '<li>'.__('Search Results for ', 'exc-proplay-theme').get_search_query().'</li>'; /** if search template */
