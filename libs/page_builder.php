        ...
        <article id="post-<?php the_ID(); ?>" <?php post_class("contents ".$content_span); ?> >
            ...
            <?php if( kvalue( $meta, 'author_info') == 'on'): ?>
                <section class="author">
                    <div class="heading">
                        <h1><?php _e('About Author', 'exc-proplay-theme');?> - <span class="text-red"><?php the_author(); ?></span></h1>
                    </div>
                    ...
                    <div class="description">
                        ...
                        <ul>
                            <?php if( $facebook = get_user_meta(get_the_author_meta('ID'), 'facebook', true) ): ?>
                                <li><a href="<?php echo $facebook; ?>" class="tooltip" title="facebook"><i class="icon-facebook"></i><?php _e('Facebook', 'exc-proplay-theme'); ?></a></li>
                            <?php endif; ?>
                            <?php if( $twitter = get_user_meta(get_the_author_meta('ID'), 'twitter', true) ): ?>
                                <li><a href="<?php echo $twitter;?>" class="tooltip" title="twitter"><i class="icon-tweeter"></i><?php _e('Twitter', 'exc-proplay-theme'); ?></a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </section>
