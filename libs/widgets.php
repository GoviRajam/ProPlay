...
class Twitter extends WP_Widget
{
                ...
                foreach((array)$reply as $rep):?>
                    ...
                    <div class="tweets">
                        ...
                        <div class="follow-tweet">
                          ...
                          <a href="<?php echo 'http://www.twitter.com/'.$rep->user->screen_name; ?>"><?php echo (kvalue($instance, 'follow_label')) ? kvalue( $instance, 'follow_label') : __('Follow us on Twitter', 'exc-proplay-theme');?></a>
                        </div>
                    </div>
    ...
    function form( $instance )
    {
        ...
        {
            $twitter_title = _e( 'Twitter', 'exc-proplay-theme' );
    ...
    ?>
            <label for="<?php echo $this->get_field_id('twitter_title'); ?>"><?php _e('Title:', 'exc-proplay-theme'); ?></label>
            ...
            <label for="<?php echo $this->get_field_id('twitter_id'); ?>"><?php _e('Twitter ID:', 'exc-proplay-theme'); ?></label>
            ...
            <label for="<?php echo $this->get_field_id('tweets_num'); ?>"><?php _e('Number of Tweets:', 'exc-proplay-theme'); ?></label>
            ...
            <label for="<?php echo $this->get_field_id('follow_label'); ?>"><?php _e('Follow us Label:', 'exc-proplay-theme'); ?></label>
...
class Recent_Posts extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct( /* Base ID */'tbrecent_posts', /* Name */'Pro Play Recent Posts', array( 'description' => 'Recent posts with images' ) );
    }
...
?>
    ...
    function form( $instance )
    {
        ...
        {
            $post_title = __( 'Recent Posts', 'exc-proplay-theme' );
            $limit = 5;
        }
    ?>
        <p>
            <label for="<?php echo $this->get_field_id('title'); ?>"><?php _e('Title:', 'exc-proplay-theme'); ?></label>
            ...
            <label for="widget-recent-posts-3-number"><?php _e('Number of posts to show:', 'exc-proplay-theme');?></label>
...
class Top_videos extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct( /* Base ID */'widget-top-vids', /* Name */'Pro Play Top Videos', array( 'description' => 'Pro play top videos with most number of likes' ) );
    }
...
?>
    ...
    function form( $instance )
    {
        ...
        {
            $post_title = __( 'Top Videos', 'exc-proplay-theme' );
            $limit = 5;
        }
    ?>
        <p>
            ...
            <label for="widget-recent-posts-3-number"><?php _e('Number of videos to show:', 'exc-proplay-theme');?></label>
...
class Recent_videos extends WP_Widget
{
    ...
    function __construct()
    {
        parent::__construct( /* Base ID */'widget-recent-vids', /* Name */'Recent Videos', array( 'description' => 'Pro play recent videos' ) );
    }
...
?>
    ...
    function form( $instance )
    {
        ...
        {
            $post_title = __( 'Recent Videos', 'exc-proplay-theme' );
            $limit = 5;
        }
    ?>
        <p>
...
class Contact_us extends WP_Widget
{
    ...
    function form( $instance )
    {
        ...
        {
            $post_title = __( 'Contact Us', 'exc-proplay-theme' );
            $address = '';
            $phone = '';
            $fax = '';
            $mobile = '';
    ...
    ?>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('address'); ?>"><?php _e('Address:', 'exc-proplay-theme');?></label><br />
        ...
        <p>
            <label for="<?php echo $this->get_field_id('phone'); ?>"><?php _e('Phone Number:', 'exc-proplay-theme'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('phone'); ?>" name="<?php echo $this->get_field_name('phone'); ?>" type="text" value="<?php echo $phone; ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('fax'); ?>"><?php _e('Fax:', 'exc-proplay-theme'); ?></label>
            <input class="widefat" id="<?php echo $this->get_field_id('fax'); ?>" name="<?php echo $this->get_field_name('fax'); ?>" type="text" value="<?php echo $fax; ?>" />
        </p>
        <p>
            <label for="<?php echo $this->get_field_id('mobile'); ?>"><?php _e('Mobile:', 'exc-proplay-theme'); ?></label>
        ...
        <p>
            <label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email:', 'exc-proplay-theme'); ?></label>
...
class Top_playlist extends WP_Widget{
    ...
    function __construct()
    {
        parent::__construct( /* Base ID */'top-videos', /* Name */'Top Playlists', array( 'description' => 'Pro play top play lists' ) );
    }
    ...
    function form( $instance )
    {
        ...
        {
            $post_title = __( 'Top Playlists', 'exc-proplay-theme' );
            $limit = 5;
        }
    ?>
        <p>
            ...
            <label for="widget-recent-posts-3-number"><?php _e('Number of lists to show:', 'exc-proplay-theme');?></label>
            <input type="text" size="3" value="<?php echo $limit; ?>" name="<?php echo $this->get_field_name('video_limit'); ?>" id="<?php echo $this->get_field_id('video_limit'); ?>">
        </p>
    <?php
    }
                ...
                <ul>
                    <?php if( $facebook = kvalue($instance, 'facebook_url')):?>
                        ...
                        <div>
                          ...
                          <span><?php _e('Facebok Followers', 'exc-proplay-theme'); ?></span>
                        </div>
                        </li>
                    <?php endif;?>
                    <?php if( $twitter = kvalue($instance, 'twitter_url')):?>
                        ...
                        <div>
                          ...
                          <span><?php _e('Twitter Followers', 'exc-proplay-theme'); ?></span>
                        </div>
                        </li>
                    <?php endif;?>
                    <?php if( $google_plus = kvalue($instance, 'gplus_url')):?>
                        ...
                        <div>
                          ...
                          <span><?php _e('Google+ Followers', 'exc-proplay-theme'); ?></span>
                        </div>
                        </li>
                    <?php endif;?>
            </ul>
...
<?php   }
    ...
    function form( $instance )
    {
        ...
        {
            $post_title = __( 'Social Networks', 'exc-proplay-theme' );
            $facebook_url = '';
            $twitter_url = '';
            $gplus_url = '';
        }
    ?>
        ...
        <p>
            <label for="facebook"><?php _e('Facebook ID:', 'exc-proplay-theme');?></label><br />
        ...
        <p>
            <label for="twitter"><?php _e('Twitter ID:', 'exc-proplay-theme');?></label><br />
        ...
        <p>
            <label for="twitter"><?php _e('Gplus URL:', 'exc-proplay-theme');?></label><br />
