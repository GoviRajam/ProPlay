...
class FW_Metaboxes
{
    ...
    function fw_post_meta_box()
    {
        ...
        add_meta_box( 'video_settings', __('Video Settings', 'exc-proplay-theme'), array( $this, 'post_settings' ),
                         'wpnukes_videos', 'normal',  'core' );
        add_meta_box( 'audio_settings', __('Audio Settings', 'exc-proplay-theme'), array( $this, 'post_settings' ),
                         'wpnukes_audios', 'normal',  'core' );
        add_meta_box( 'post_settings', __('Post Settings', 'exc-proplay-theme'), array( $this, 'post_settings' ),
                         'post', 'normal',  'core' );
        add_meta_box( 'page_settings', __('Page Settings', 'exc-proplay-theme'), array( $this, 'post_settings' ),
                         'page', 'normal',  'core' );
    }
