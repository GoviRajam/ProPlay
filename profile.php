    ...
    <div class="row">
        <article class="contents span8">
            <div class="single-contents">
                ...
                <?php if( !is_user_logged_in() || !$user_data->ID ) die( __('You are not authorized to access this area', 'exc-proplay-theme') ); ?>
                    ...
                    <div class="tab-bar clearfix">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <?php if( kvalue( $profile_settings, 'channel' ) == 'on' || is_super_admin() ): ?>
                                <li><a href="#tab1"><?php _e('Channels', 'exc-proplay-theme'); ?></a></li>
                            <?php endif; ?>

                            <?php if( kvalue( $profile_settings, 'playlist' ) == 'on' || is_super_admin() ): ?>
                                <li><a href="#tab2"><?php _e('Playlists', 'exc-proplay-theme'); ?></a></li>
                            <?php endif; ?>

                            <?php if( kvalue( $profile_settings, 'video' ) == 'on' || is_super_admin() ): ?>
                                <li><a href="#tab3"><?php _e('Videos', 'exc-proplay-theme'); ?></a></li>
                            <?php endif; ?>

                            <?php if( kvalue( $profile_settings, 'album' ) == 'on' || is_super_admin() ): ?>
                                <li><a href="#tab4"><?php _e('Albums', 'exc-proplay-theme'); ?></a></li>
                            <?php endif; ?>

                            <?php if( kvalue( $profile_settings, 'audio' ) == 'on' || is_super_admin() ): ?>
                                <li><a href="#tab5"><?php _e('Audios', 'exc-proplay-theme'); ?></a></li>
                            <?php endif; ?>

                        </ul>

                        <a href="#" id="user_profile" class="edit-profile">
                            <?php _e('Edit Profile', 'exc-proplay-theme'); ?>
                            <i class="icon-edit"></i>
                        </a>
                    ...
                    <div class="tab-content vid-condense">
                        ...
                        <?php if( kvalue( $profile_settings, 'channel' ) == 'on' || is_super_admin() ): ?>
                            <div class="tab-pane active" id="tab1">
                                <div class="heading">
                                    <h2><?php _e('Channels', 'exc-proplay-theme'); ?></h2>

                                    <a href="#" id="add_channel" class="btn btn-red pull-right">
                                        <?php _e('Add New Channel', 'exc-proplay-theme'); ?>
                                    </a>
                                </div>
                        ...
                        <?php if( kvalue( $profile_settings, 'playlist' ) == 'on' || is_super_admin() ): ?>
                            <div class="tab-pane active" id="tab2">
                                <div class="heading">
                                    <h2><?php _e('Playlists', 'exc-proplay-theme'); ?></h2>

                                    <a href="#" id="add_playlist" class="btn btn-red pull-right">
                                        <?php _e('Add New Playlist', 'exc-proplay-theme'); ?>
                                    </a>
                                </div>
                        ...
                        <?php if( kvalue( $profile_settings, 'video' ) == 'on' || is_super_admin() ): ?>
                            <div class="tab-pane" id="tab3">
                                ...
                                <div class="heading">
                                    <h2>&nbsp;<?php //_e('Videos Collection', 'exc-proplay-theme'); ?></h2>

                                    <div class="pull-right">
                                    <a href="javascript:void(0);" id="add_video" class="btn btn-red" style="position:relative;">
                                        <?php _e('Add New Video', 'exc-proplay-theme'); ?>
                                    </a>
                                    <?php if( kvalue( $profile_settings, 'video_upload' ) == 'on' || is_super_admin() ): ?>
                                        <a href="javascript:void(0);" id="upload_video" class="btn btn-red" style="position:relative; margin-left: 10px;">
                                            <?php _e('Upload New Video', 'exc-proplay-theme'); ?>
                                        </a>
                                    <?php endif;?>
                                    </div>
                        ...
                        <?php if( kvalue( $profile_settings, 'album' ) == 'on' || is_super_admin() ): ?>
                            <div class="tab-pane active" id="tab4">
                                <div class="heading">
                                    <h2><?php _e('Albums', 'exc-proplay-theme'); ?></h2>

                                    <a href="#" id="add_album" class="btn btn-red pull-right">
                                        <?php _e('Add New Album', 'exc-proplay-theme'); ?>
                                    </a>
                                </div>
                        ...
                        <?php if( kvalue( $profile_settings, 'audio' ) == 'on' || is_super_admin() ): ?>
                            <div class="tab-pane" id="tab5">
                                ...
                                <div class="heading">
                                    <h2>&nbsp;<?php //_e('Audio Collection', 'exc-proplay-theme'); ?></h2>

                                    <div class="pull-right">
                                        <a href="javascript:void(0);" id="add_audio" class="btn btn-red" style="position:relative;">
                                            <?php _e('Add New Audio', 'exc-proplay-theme'); ?>
                                        </a>
                                        <?php if( kvalue( $profile_settings, 'audio_upload' ) == 'on' || is_super_admin() ):?>
                                            <a href="javascript:void(0);" id="upload_audio" class="btn btn-red" style="position:relative; margin-left: 10px;">
                                                <?php _e('Upload New Audio', 'exc-proplay-theme'); ?>
                                            </a>
                                        <?php endif;?>
                                    </div>
...
<div id="dialog-load">
    <div class="load-vid"> <i class="icon-download-arrow"></i>
        ...
        <h3>
            <?php _e('Getting Contents ', 'exc-proplay-theme'); ?>
        </h3>
    </div>
</div>
