    ...
    <article class="contents span12">
        <div style="background-image:url(<?php echo $GLOBALS['_webnukes']->fw_get_settings('sub_background', 'signup_bg_image'); ?>);" class="signing-block">
            <section class="login-box">
                <div class="heading">
                    <h1 class="text-red"><?php _e('Register Yourself', 'exc-proplay-theme'); ?></h1>
                </div>
                ...
                <form action="<?php echo get_permalink();?>" method="post">
                    ...
                    <p id="reg_passmail"><?php _e('A password will be e-mailed to you.', 'exc-proplay-theme'); ?></p>

                    <input type="submit" value="<?php _e('Sign Up', 'exc-proplay-theme'); ?>" class="btn btn-red">
                </form>
            </section>
        </div>
    </article>
