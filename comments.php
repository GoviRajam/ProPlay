...
if ( post_password_required() ) :?>
    <p class="alert"><?php _e( 'This post is password protected. Enter the password to view comments.', 'exc-proplay-theme' ); ?></p>
<?php return;
endif;?>
...
<section class="video-comments">
    ...
    <?php else:
        ...
        if( ! comments_open()) : ?>
            <h3><?php _e( 'Sorry comments are closed for this Post.', 'exc-proplay-theme' ); ?></h3>
        <?php endif;
    endif; ?>
